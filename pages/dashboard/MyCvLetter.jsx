...
const MyCvLetter = () => {
  ...
  return (
    ...
    //       className="flex items-center px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-600 transition-colors duration-200 font-medium shadow-sm"
    //     >
    ...
    //                       className="text-purple-600 hover:text-pink-600 transition-colors duration-200"
    //                     >
    ...
    //             className="px-4 py-2 text-sm font-medium text-white bg-purple-600 rounded-md hover:bg-purple-600"
    //           >
    //             Save
    //           </button>
    //         </div>
