            ...
            <div className="max-w-6xl mx-auto p-6">
              ...
              <div className="mt-4 flex gap-4">
                <div className="flex flex-col sm:flex-row justify-center items-center mb-8 gap-4 mt-4 p-4">
                  <button className="flex justify-center items-center px-4 py-2 w-full sm:w-auto bg-pink-600 hover:bg-purple-600 text-white rounded-lg  transition-colors duration-200 font-medium shadow-sm gap-2">
                    <FaUpload /> Upload
                  </button>
                  <button
