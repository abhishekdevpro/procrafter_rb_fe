...
//                   className="flex items-center bg-purple-600 text-white px-4 py-2 text-md font-semibold border-2 rounded-xl"
//                 >
//                   {/* <img
...
//               className="text-black hover:text-purple-600 focus:outline-none px-3 py-2 rounded-md text-sm font-medium"
//             >
//               <svg
//                 className="w-6 h-6"
//                 fill="none"
...
//                 <Link
//                   href="/"
//                   className="bg-purple-600 text-white  block px-3 py-2 rounded-md text-base font-semibold"
//                   onClick={() => {
//                     handleLogout();
//                     handleLinkClick();
//                   }}
