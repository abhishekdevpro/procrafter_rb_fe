    ...
    <div>
      <div className="m-10 mx-40 p-5  shadow-2xl">
        <h1 className="text-4xl font-semibold my-4 underline ">
          Careers at Resume Intellect
        </h1>
        <h1 className="text-2xl font-semibold my-2 mt-5 ">Join Our Team</h1>
        At Resume Intellect, we are committed to helping individuals achieve
        their career goals through expertly crafted resumes and personalized
        career services. Our team is passionate about making a difference in the
        ...
        At Resume Intellect, we believe in the power of collaboration. Our team
        ...
        Your work at Resume Intellect will have a direct impact on our clients’
        ...
        client has a positive experience with Resume Intellect.
        ...
        for a position at Resume Intellect, please send your resume and a cover
        letter to [career@Resume Intellect.ca](mailto:career@Resume
        Intellect.ca).
        <h1 className="text-2xl font-semibold my-2 mt-5">
          Join Us and Make a Difference
        </h1>
        At Resume Intellect, you’ll have the opportunity to make a meaningful
