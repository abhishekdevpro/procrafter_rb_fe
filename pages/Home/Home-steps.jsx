      ...
      <div className="w-full md:w-1/2">
        ...
        <div className="space-y-4">
          {steps.map((step, index) => (
            <div
              key={index}
              className="border-l-4 border-purple-600 bg-white p-4 rounded-lg shadow-sm cursor-pointer"
        ...
        <Link href={isAuthenticated ? "/dashboard/resume-builder" : "/login2"}>
          <button className="mt-8 bg-purple-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-pink-600 transition-colors">
            Build my resume
          </button>
        </Link>
      </div>
