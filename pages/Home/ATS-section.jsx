...
const ATSResumeSection = () => {
  ...
  return (
    <div className="relative w-full min-h-[400px] bg-gradient-to-br from-purple-600 to-pink-600 p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="space-y-6 mb-12">
          ...
          >
            <button className="bg-pink-600 hover:bg-pink-500 text-white font-medium mt-4 py-3 px-6 rounded-lg transition-colors">
