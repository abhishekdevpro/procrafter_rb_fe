...
//     <>
//       <Navbar />
//       <div className="p-6 max-w-7xl w-full mx-auto font-sans   bg-gradient-to-br from-white to-purple-200">
//         {/* Intro Section */}
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg flex-1">
              ...
              <div className="mt-6">
                <button
                  ...
                  // onClick={goToNextPage}
                  // className="w-full bg-purple-600 text-white text-lg font-semibold py-3 rounded-lg"
                  className={`w-full bg-purple-600 text-white text-lg font-semibold py-3 rounded-lg transition 
    ${
