...
//             <button className="mt-6 w-full bg-purple-600 text-white text-lg font-semibold py-3 rounded-lg ">
//               {t("Start applying")}
//             </button>
...
//                   <CheckCircle className="text-pink-600 mr-2 mt-1 flex-shrink-0" size={18} />
//                   <span>{t(feature)}</span>
//                 </li>
//               ))}
        ...
        <div className="max-w-5xl w-full bg-white shadow-lg rounded-lg p-6 md:flex">
          ...
          <div className=" p-6">
            ...
            {/* <button
              ...
              className="mt-6 w-full bg-purple-600 text-white text-lg font-semibold py-3 rounded-lg "
            >
              {t("Start applying")}
            </button> */}
            <button
