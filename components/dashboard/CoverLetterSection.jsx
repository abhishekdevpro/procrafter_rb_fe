...
//         <button
//           onClick={handleClick}
//           className="px-6 py-2 border border-purple-600 text-purple-600 rounded-lg hover:bg-blue-50"
//         >
    ...
    <div className="border border-gray-200 rounded-lg p-4 sm:p-6 mb-6">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
        ...
        <div className="sm:ml-4">
          <button
            onClick={handleClick}
            className="w-full sm:w-auto px-4 py-2 border border-purple-600 text-purple-600 rounded-md hover:bg-teal-50 transition"
          >
            {t("dashboard_cvletter.viewCoverLetters")}
          </button>
        </div>
