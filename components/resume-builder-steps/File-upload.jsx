...
//           ${isDragActive ? 'border-purple-600 bg-blue-50' : 'border-gray-300 hover:border-purple-600'}
...
//           className="px-8 py-3 bg-pink-600 text-black rounded-lg font-medium hover:bg-purple-600 transition-colors
